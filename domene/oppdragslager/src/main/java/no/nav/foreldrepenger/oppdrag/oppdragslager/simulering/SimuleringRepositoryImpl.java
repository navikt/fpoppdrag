...
@ApplicationScoped
public class SimuleringRepositoryImpl implements SimuleringRepository {

    private EntityManager entityManager;

    SimuleringRepositoryImpl() {
        // for CDI proxy
    }

    @Inject
    public SimuleringRepositoryImpl(@VLPersistenceUnit EntityManager entityManager) {
