...
@ApplicationScoped
public class TilkjentYtelseRepositoryImpl implements TilkjentYtelseRepository {

    private EntityManager entityManager;

    TilkjentYtelseRepositoryImpl() {
        // for CDI
    }

    @Inject
    public TilkjentYtelseRepositoryImpl(@VLPersistenceUnit EntityManager entityManager) {
