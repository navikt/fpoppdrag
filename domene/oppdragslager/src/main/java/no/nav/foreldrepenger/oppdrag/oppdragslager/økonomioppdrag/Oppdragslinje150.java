...
public class Oppdragslinje150 extends BaseEntitet {
    ...
    @Column(name = "bruk_kjoere_plan", nullable = false)
    private String brukKjoereplan;
    ...
    public String getBrukKjoereplan() {
        return brukKjoereplan;
    }
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(kodeEndringLinje, oppdrlinje150.getKodeEndringLinje())
                ...
                && Objects.equals(vedtaksdato, oppdrlinje150.getVedtaksdato())
                ...
                && Objects.equals(brukKjoereplan, oppdrlinje150.getBrukKjoereplan())
    ...
    @Override
    public int hashCode() {
        return Objects.hash(kodeEndringLinje, kodeStatusLinje, datoStatusFom, vedtaksdato, delytelseId, kodeKlassifik, vedtakPeriode, sats, fradragTillegg, typeSats, brukKjoereplan, saksbehId, utbetalesTilId, refFagsystemId, refDelytelseId);
    }
    ...
    public static class Builder {
        ...
        public Builder medVedtakId(LocalDate vedtaksdato) {
        ...
        public Oppdragslinje150 build() {
            ...
            oppdragslinje150.vedtaksdato = vedtaksdato;
            ...
            oppdragslinje150.brukKjoereplan = brukKjoreplan;
        ...
        public void verifyStateForBuild() {
            ...
            Objects.requireNonNull(brukKjoreplan, "brukKjoereplan");
            Objects.requireNonNull(saksbehId, "saksbehId");
            Objects.requireNonNull(henvisning, "henvisning");
            Objects.requireNonNull(delytelseId, "delytelseId");
    ...
    public String toString() {
        return getClass().getSimpleName() + "<" + //$NON-NLS-1$
                ...
                + "vedtaksdato=" + vedtaksdato + ", " //$NON-NLS-1$ //$NON-NLS-2$
                ...
                + "brukKjoereplan=" + brukKjoereplan + ", " //$NON-NLS-1$ //$NON-NLS-2$
