...
public class KodeverkValidatorTest {
    ...
    public void testSkalPasserePåGyldigInput() {
        TestKodeliste kl = new TestKodeliste("ARKIV_FILTYPE", "PDF");
    ...
    public void testSkalPasserePåGyldigInputForliste() {
        TestListeAvKodeliste kl = new TestListeAvKodeliste("ARKIV_FILTYPE", "PDF");
    ...
    public void testSkalFeilePåUgyldigeTegnIKode() {
        TestKodeliste kl = new TestKodeliste("ARKIV_FILTYPE", "P[^$");
        Set<ConstraintViolation<TestKodeliste>> violations = validator.validate(kl);
        assertEquals(1, violations.size());
        assertEquals("kodeverk kode feilet validering", violations.iterator().next().getMessage());
    }
