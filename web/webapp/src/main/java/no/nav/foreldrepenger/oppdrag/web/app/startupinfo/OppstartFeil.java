...
interface OppstartFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FPO-753407", feilmelding = "Uventet exception ved oppstart", logLevel = ERROR)
    Feil uventetExceptionVedOppstart(Exception e);

    @TekniskFeil(feilkode = "FPO-753409", feilmelding = "Selftest %s: %s. Endpoint: %s. Responstid: %s. Feilmelding: %s.", logLevel = INFO)
