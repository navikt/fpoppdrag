...
public class StartSimuleringTjenesteImplTest {
    ...
    public void setup() {
        ...
        simuleringTjeneste = new StartSimuleringTjenesteImpl(simuleringXmlRepository, simuleringRepository, oppdragConsumerMock, resultatTransformer, simuleringBeregningTjeneste);
    ...
    public void simulerer_for_bruker_uten_inntrekk_dersom_første_resultat_gir_feilutbetaling_og_inntrekk() throws Exception {
        ...
        LocalDate forfallsdato = FPDateUtil.iDag().plusMonths(1).withDayOfMonth(20);
        LocalDate fom = forfallsdato.withDayOfMonth(1);
        String gjelderId = "24153532444";
        String fagsysId = "423535";
        SimulerBeregningResponse response = lagRespons(gjelderId, fagsysId, pattern.format(FPDateUtil.iDag()));
