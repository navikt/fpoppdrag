...
import no.nav.foreldrepenger.oppdrag.oppdragslager.tilkjentytelse.TilkjentYtelseRepositoryImpl;
...
public class TilkjentYtelseTjenesteTest {
    ...
    private TilkjentYtelseRepository tilkjentYtelseRepository = new TilkjentYtelseRepositoryImpl(repositoryRule.getEntityManager());
